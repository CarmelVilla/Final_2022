...
The p-value from the chi-squared test is 0.0002732, which is too small therefore the vaccine is not effective in preventing Covid-19. On the Fisher's Exact Test there is a p-value 0.0002162 meaning there is a difference in getting Covid-19  and being a female. We fail to reject the null hypothesis because females can still get Covid-19 with the vaccine or the placebo.
